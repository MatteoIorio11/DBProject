...
namespace HospitalDBProject.Controllers
{
    public class InfermieriController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdInfermiere,Nome,Cognome,CodiceFiscale,DataNascita,Genere")] infermiere infermiere)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdInfermiere,Nome,Cognome,CodiceFiscale,DataNascita,Genere")] infermiere infermiere)
        {
            if (ModelState.IsValid)
            {
