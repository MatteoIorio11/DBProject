...
namespace HospitalDBProject.Controllers
{
    public class PazientiController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdPaziente,Nome,Cognome,CodiceFiscale,DataNascita,Genere")] paziente paziente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdPaziente,Nome,Cognome,CodiceFiscale,DataNascita,Genere")] paziente paziente)
        {
            if (ModelState.IsValid)
            {
